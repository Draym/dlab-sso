...
router.get(Endpoint.APPLICATION_Get, validatePathRequest(ApplicationGetRequest), authMiddleware(), hasRole(Role.Operator), handle.bind(ctrl.get))
...
router.get(Endpoint.APPLICATION_Details, authMiddleware(scope), handle.bind(ctrl.details))
