enum Endpoint {
    ...
    APPLICATION_SCOPE_Add = "/application/scopes",
    APPLICATION_SCOPE_Delete = "/application/scopes",
    APPLICATION_USER_Add = "/application/users",
    APPLICATION_USER_Update = "/application/users",
    APPLICATION_USER_Delete = "/application/users",
    APPLICATION_USER_All = "/application/users",
    APPLICATION_USER_IsAllowed = "/application/users/is-allowed",
    LOGIN = "/auth/login",
    LOGOUT = "/auth/logout",
